...
import GlobalPagination from "../../components/ui/GlobalPagination"; // Ensure correct import path

const Index = () => {
  const { getData, data, isLoading, deleteData, totalCount } = useServiceStore(); // Assuming totalCount is provided by the store
